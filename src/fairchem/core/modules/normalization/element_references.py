...
class ElementReferences(nn.Module):
    ...
    def compute_references(batch, tensor, elem_refs, operation):
        ...
        # Inline computation to avoid autocast overhead and unnecessary zeros allocation
        # Efficient scatter_add using index_add, since reduce="sum" and initial zeros
        # No need for torch.autocast since it is always disabled
